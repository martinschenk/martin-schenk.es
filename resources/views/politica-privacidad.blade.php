...
{{--        </div>--}}
    ...
    <section class="">
        ...
        px-8 py-4  ">
            ...
            <h2 class="h2-normal">Principios aplicados en el tratamiento de datos</h2>
            <p class="p-normal">
            ...
            <h2 class="h2-normal">Obtención de datos personales</h2>
            <p class="p-normal">
            ...
            <h2 class="h2-normal">Derechos</h2>
            <p class="p-normal">
            ...
            <ul class="ul-normal">
                ...
                <li class="li-normal">Oponerse al tratamiento.</li>
            </ul>
            </p>
            <p class="p-normal">
            ...
            <h2 class="h2-normal" id="finalidad-del-tratamiento-de-datos-personales">Finalidad del tratamiento de datos personales</h2>
            <p class="p-normal">
            ...
            <h2 class="h2-normal">Seguridad de los datos personales</h2>
            <p class="p-normal">
            ...
            <p class="p-normal">
                El sitio Web está alojado en:  hetzner.com. La seguridad de los datos está garantizada, ya que toman todas las medidas de seguridad necesarias para ello. Puede consultar su política de privacidad para tener más información.
            </p>
            ...
            <h2 class="h2-normal">Contenido de otros sitios web</h2>
            <p class="p-normal">
            ...
            <h2 class="h2-normal">Categorías de datos personales</h2>
            <p class="p-normal">
            ...
            <h2 class="h2-normal">Conservación de datos personales</h2>
            <p class="p-normal">
            ...
            <h2 class="h2-normal">Navegación Web</h2>
            <p class="p-normal">
            ...
            <h2 class="h2-normal">Exactitud y veracidad de los datos personales</h2>
            <p class="p-normal">
            ...
            <h2 class="h2-normal">Aceptación y consentimiento</h2>
            <p class="p-normal">
            ...
            <h2 class="h2-normal">Cambios en la Política de Privacidad</h2>
            <p class="p-normal">
